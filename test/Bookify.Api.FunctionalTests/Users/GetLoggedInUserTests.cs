...
public class GetLoggedInUserTests : BaseFunctionalTest
{
    ...
    [Fact]
    public async Task Get_ShouldReturnUnauthorized_WhenAccessTokenMissing()
    {
        //Act
        var response = await HttpClient.GetAsync("v1/users/me");
    ...
    public async Task Get_ShouldReturnUser_WhenAccessTokenIsNotMissing()
    {
        ...
        //Act
        var user = await HttpClient.GetFromJsonAsync<UserResponse>("v1/users/me");
