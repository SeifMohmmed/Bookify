...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260305204838_Add_RoleTable")]
    partial class Add_RoleTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("Amanities")
                        .IsRequired()
                        .HasColumnType("integer[]")
                        .HasColumnName("amanities");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Money", "AmenitiesUpChange", b1 =>
                        {
                            ...
                            b1.Property<decimal>("Amount")
                                .HasColumnType("numeric")
                                .HasColumnName("amenities_up_change_amount");

                            b1.Property<string>("Currency")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("amenities_up_change_currency");
                    ...
                    b.Navigation("AmenitiesUpChange")
                        .IsRequired();
